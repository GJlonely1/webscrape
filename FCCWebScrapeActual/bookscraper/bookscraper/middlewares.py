...
class ScrapeOpsFakeUserAgentMiddleware: 
    @classmethod
    # Purpose is to make sure we have access to the Crawler Settings when the class is initialized
    def from_crawler(cls, crawler):
    ...
    # Create a new header every time using the data that it gets from the fake browser header endpoint
