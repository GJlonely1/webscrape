...
class BookspiderSpider(scrapy.Spider):
    ...
    # Can specify the Feeds settings here which overrides settings.py changes 
    custom_settings = {
        'FEEDS' : {
    ...
    def parse_book_page(self, response):
        ...
        book_item["price_exclude_tax"] = table_rows[2].css("td ::text").get(),
        book_item["price_include_tax"] = table_rows[3].css("td ::text").get(),
